...
type Subscription struct {
	...
	VideoFilter string    `boil:"video_filter" json:"video_filter" toml:"video_filter" yaml:"video_filter"`
...
var SubscriptionTableColumns = struct {
	...
	Favorite:    "subscriptions.favorite",
	ChannelID:   "subscriptions.channel_id",
	UserID:      "subscriptions.user_id",
	VideoFilter: "subscriptions.video_filter",
}
...
var SubscriptionWhere = struct {
	...
	Favorite:    whereHelperbool{field: "\"subscriptions\".\"favorite\""},
	ChannelID:   whereHelperstring{field: "\"subscriptions\".\"channel_id\""},
	UserID:      whereHelperstring{field: "\"subscriptions\".\"user_id\""},
	VideoFilter: whereHelperstring{field: "\"subscriptions\".\"video_filter\""},
}
...
func (o *Subscription) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (r *subscriptionR) GetChannel() *Channel {
	if r == nil {
		return nil
	}
...
var (
	subscriptionAllColumns            = []string{"id", "created_at", "updated_at", "favorite", "channel_id", "user_id", "video_filter"}
	subscriptionColumnsWithoutDefault = []string{"id", "created_at", "updated_at", "favorite", "channel_id", "user_id"}
	subscriptionColumnsWithDefault    = []string{"video_filter"}
...
func (o *Subscription) Channel(mods ...qm.QueryMod) channelQuery {
	queryMods := []qm.QueryMod{
...
func (subscriptionL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSubscription any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (subscriptionL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSubscription any, mods queries.Applicator) error {
	var slice []*Subscription
	var object *Subscription
...
// SetChannel of the subscription to the related item.
// Sets o.R.Channel to related.
// Adds o to related.R.Subscriptions.
func (o *Subscription) SetChannel(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Channel) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func (o *Subscription) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"subscriptions\"", updateOnConflict, ret, update, conflict, insert)
