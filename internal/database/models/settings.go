...
var SettingWhere = struct {
	...
	Data:      whereHelper__byte{field: "\"settings\".\"data\""},
...
var (
	settingAllColumns            = []string{"id", "created_at", "updated_at", "data", "user_id"}
	settingColumnsWithoutDefault = []string{"id", "created_at", "updated_at", "data", "user_id"}
...
func (settingL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSetting any, mods queries.Applicator) error {
	var slice []*Setting
	var object *Setting
	...
	if singular {
		...
		foreign.R.Settings = append(foreign.R.Settings, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserID == foreign.ID {
				...
				foreign.R.Settings = append(foreign.R.Settings, local)
				break
			}
		}
	}
...
func (o *Setting) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	if related.R == nil {
		related.R = &userR{
			Settings: SettingSlice{o},
		}
	} else {
		related.R.Settings = append(related.R.Settings, o)
	}
