...
func (o *Playlist) GetPlaylistItems() PlaylistItemSlice {
	if o == nil {
		return nil
	}
...
var (
	...
	playlistColumnsWithoutDefault = []string{"id", "created_at", "updated_at", "user_id", "slug", "name", "ttl_days", "max_size", "youtube_playlist_id"}
	playlistColumnsWithDefault    = []string{"system", "description"}
