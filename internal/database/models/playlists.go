...
func (playlistL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybePlaylist any, mods queries.Applicator) error {
	var slice []*Playlist
	var object *Playlist
...
func (playlistL) LoadPlaylistItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybePlaylist any, mods queries.Applicator) error {
	var slice []*Playlist
	var object *Playlist
