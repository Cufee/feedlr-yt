...
func (viewL) LoadVideo(ctx context.Context, e boil.ContextExecutor, singular bool, maybeView any, mods queries.Applicator) error {
	var slice []*View
	var object *View
...
// loaded structs of the objects. This is for an N-1 relationship.
func (viewL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeView any, mods queries.Applicator) error {
	var slice []*View
	var object *View
