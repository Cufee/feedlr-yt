...
type Channel struct {
	...
	FeedUpdatedAt     time.Time `boil:"feed_updated_at" json:"feed_updated_at" toml:"feed_updated_at" yaml:"feed_updated_at"`
...
var ChannelTableColumns = struct {
	...
	FeedUpdatedAt:     "channels.feed_updated_at",
...
var ChannelWhere = struct {
	...
	FeedUpdatedAt     whereHelpertime_Time
	...
	FeedUpdatedAt:     whereHelpertime_Time{field: "\"channels\".\"feed_updated_at\""},
...
type channelR struct {
	PodcastShow   *PodcastShow      `boil:"PodcastShow" json:"PodcastShow" toml:"PodcastShow" yaml:"PodcastShow"`
...
func (o *Channel) GetPodcastShow() *PodcastShow {
	if o == nil {
		return nil
	}

	return o.R.GetPodcastShow()
}

func (r *channelR) GetPodcastShow() *PodcastShow {
	if r == nil {
		return nil
	}

	return r.PodcastShow
}

func (o *Channel) GetSubscriptions() SubscriptionSlice {
	if o == nil {
		return nil
	}
...
func (r *channelR) GetSubscriptions() SubscriptionSlice {
	if r == nil {
		return nil
	}
...
func (o *Channel) GetVideos() VideoSlice {
	if o == nil {
		return nil
	}

	return o.R.GetVideos()
}

func (r *channelR) GetVideos() VideoSlice {
	if r == nil {
		return nil
	}
...
var (
	channelAllColumns            = []string{"id", "created_at", "updated_at", "title", "description", "thumbnail", "feed_updated_at", "uploads_playlist_id"}
	channelColumnsWithoutDefault = []string{"id", "created_at", "updated_at", "title", "description"}
	channelColumnsWithDefault    = []string{"thumbnail", "feed_updated_at", "uploads_playlist_id"}
...
// PodcastShow pointed to by the foreign key.
func (o *Channel) PodcastShow(mods ...qm.QueryMod) podcastShowQuery {
	...
	return PodcastShows(queryMods...)
}

// Subscriptions retrieves all the subscription's Subscriptions with an executor.
func (o *Channel) Subscriptions(mods ...qm.QueryMod) subscriptionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"subscriptions\".\"channel_id\"=?", o.ID),
	)
...
func (o *Channel) Videos(mods ...qm.QueryMod) videoQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"videos\".\"channel_id\"=?", o.ID),
	)

	return Videos(queryMods...)
}

// LoadPodcastShow allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (channelL) LoadPodcastShow(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel interface{}, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		qm.From(`podcast_shows`),
		qm.WhereIn(`podcast_shows.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load PodcastShow")
	}

	var resultSlice []*PodcastShow
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice PodcastShow")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for podcast_shows")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for podcast_shows")
	}
	...
	if singular {
		...
		object.R.PodcastShow = foreign
		if foreign.R == nil {
			foreign.R = &podcastShowR{}
		}
...
func (channelL) LoadSubscriptions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel interface{}, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		...
		qm.WhereIn(`subscriptions.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadVideos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel interface{}, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		qm.From(`videos`),
		qm.WhereIn(`videos.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetPodcastShow of the channel to the related item.
// Sets o.R.PodcastShow to related.
// Adds o to related.R.Channel.
func (o *Channel) SetPodcastShow(ctx context.Context, exec boil.ContextExecutor, insert bool, related *PodcastShow) error {
	var err error

	if insert {
		related.ChannelID = o.ID
	...
	if o.R == nil {
		...
		o.R.PodcastShow = related
	}

	if related.R == nil {
		related.R = &podcastShowR{
			Channel: o,
		}
	} else {
		related.R.Channel = o
...
func (o *Channel) AddSubscriptions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Subscription) error {
	var err error
...
// Sets related.R.Channel appropriately.
func (o *Channel) AddVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Video) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ChannelID = o.ID
...
func (o *Channel) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"channels\"", updateOnConflict, ret, update, conflict, insert)
