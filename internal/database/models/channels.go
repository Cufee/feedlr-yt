...
func (channelL) LoadSubscriptions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadVideos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
