...
func (r *userR) GetConnections() ConnectionSlice {
	if r == nil {
		return nil
	}
...
func (o *User) Connections(mods ...qm.QueryMod) connectionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"connections\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadConnections(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`connections`),
		qm.WhereIn(`connections.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddConnections(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Connection) error {
	var err error
